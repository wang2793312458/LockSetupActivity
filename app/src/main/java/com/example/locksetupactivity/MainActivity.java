package com.example.locksetupactivity;
...
import com.example.locksetupactivity.view.LockPatternView;

import java.util.ArrayList;
import java.util.List;

public class MainActivity extends AppCompatActivity implements LockPatternView.OnPatternListener, View.OnClickListener {
            ...
            case R.id.right_btn:
                if (step == STEP_2) {
                    ...
                    if (bool) {
                        ...
                        editor.commit();
                        Toast.makeText(MainActivity.this, "手势密码解除成功",
                        ...
                        editor.commit();
                        Toast.makeText(MainActivity.this, "手势密码设置成功",
                                Toast.LENGTH_SHORT).show();
                    }
